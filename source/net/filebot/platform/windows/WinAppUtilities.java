...
public class WinAppUtilities {
	...
	public static void initializeApplication() {
		...
		UIManager.put("TitledBorder.border", createCompoundBorder(createLineBorder(new Color(0xD7D7D7), 1, true), createCompoundBorder(createMatteBorder(8, 6, 7, 6, new Color(0xE5E5E5)), createEmptyBorder(0, 2, 0, 2))));
	}
