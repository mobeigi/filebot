...
public class AcoustIDClient implements MusicIdentificationService {
	...
	public String lookup(String duration, String fingerprint) throws IOException, InterruptedException, ParseException {
		...
		postParam.put("duration", duration);
		postParam.put("fingerprint", fingerprint);

		String cacheKey = postParam.values().toString();
		...
		URL url = new URL("http://api.acoustid.org/v2/lookup?client=" + apikey + "&meta=recordings+releasegroups+compress");
